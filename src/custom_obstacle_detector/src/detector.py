...
LIMX = 50  # Example limit for x-axis
LIMY = 50  # Example limit for y-axis
LIMZ = 50  # Example limit for z-axis
...
# LIMY = 100  # Example limit for y-axis
# LIMZ = 100  # Example limit for z-axis
...
#     points[..., 0] = np.round(pc['x'],1)
#     points[..., 1] = np.round(pc['z'],1)
#     points[..., 2] = -np.round(pc['y'],1)
#     rgb = np.zeros(shape)
#     rgb[..., 0] = pc['r']
#     rgb[..., 1] = pc['g']
#     rgb[..., 2] = pc['b']
#     colormap = np.copy(rgb)
#     threshold = 240
#     nearly_white_indexes = np.where((rgb[..., 0] > threshold) & 
#                                 (rgb[..., 1] > threshold) & 
#                                 (rgb[..., 2] > threshold))
#     white_points = points[nearly_white_indexes]
#     # for point in white_points:
#     #     z_value = point[2]
#     #     matching_indexes = np.where(points[..., 2] == z_value)
#     #     colormap[matching_indexes] = 255
#     # Extract z-values from white points
#     # print(white_points)

#     x_values = white_points[:, 0]
#     y_values = white_points[:, 1]

#     # Find the matching indexes
#     xmatching_indexes = np.isin(points[..., 0], x_values)
#     ymatching_indexes = np.isin(points[..., 1], y_values)

#     # print(xmatching_indexes[xmatching_indexes==True])
#     # print(ymatching_indexes[ymatching_indexes==True])

#     # matching_indexes = np.intersect1d(xmatching_indexes, ymatching_indexes)
#     matching_indexes = np.where(xmatching_indexes & ymatching_indexes)


#     # print(matching_indexes)
#     # Update colormap
#     colormap[matching_indexes] = np.array([255,255,255])
...
#     xy_positions = white_bottom_layer[:, :2]
